...
The wire contract is defined in `siege-web/docs/webhooks/day-role-sync.md`
(tracked by `glitchwerks/rsl-siege-manager#400`; not yet authored). Siege-web is the producer;
